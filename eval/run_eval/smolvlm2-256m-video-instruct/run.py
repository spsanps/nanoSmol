#!/usr/bin/env python
"""LightEval launcher for `HuggingFaceTB/SmolVLM2-256M-Video-Instruct`.
...
DEFAULT_OUTPUT = EVAL_DIR / "output" / "smolvlm2-256m-video-instruct"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run LightEval on SmolVLM2-256M-Video-Instruct")
...
def main() -> int:
    ...
    print(f"[smolvlm2-256m-video-instruct] Launching LightEval:\n{printable}")
